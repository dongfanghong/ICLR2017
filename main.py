...
flags.DEFINE_string("checkpoint_dir", "/atlas/u/dfh13/checkpoint3", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("sample_dir", "/atlas/u/dfh13/samples", "Directory name to save the image samples [samples]")
