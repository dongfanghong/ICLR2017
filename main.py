...
flags.DEFINE_string("checkpoint_dir", "/atlas/u/dfh13/checkpoint_new2", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("sample_dir", "/atlas/u/dfh13/samples_new", "Directory name to save the image samples [samples]")
