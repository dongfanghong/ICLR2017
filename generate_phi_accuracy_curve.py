...
def accuracy_metric(train_X, train_y, test_X, test_y):
        ...
        gradient_accuracy = accuracy_metric_impl(train_X, train_y, test_X, test_y, model, name="Tree based Classifier")
...
def make_plot_from_features(features_file, labels_file, out_file_name="phi_plot", title=None):
  ...
  plt.plot(x_points, boosting_y_points, 'g', label="Forest")
  plt.legend(loc='best')
